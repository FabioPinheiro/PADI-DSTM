...
class Cicle
{
    static void Main(string[] args)
    {
        ...
        {
            res = PadiDstm.TxBegin();
            PadInt pi_a1 = PadiDstm.CreatePadInt(21);
            PadInt pi_b1 = PadiDstm.CreatePadInt(201);
            PadInt pi_c1 = PadiDstm.CreatePadInt(101);
            pi_a1.Write(0);
            pi_b1.Write(0);
            res = PadiDstm.TxCommit();
        }
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            PadInt pi_d1 = PadiDstm.AccessPadInt(21);
            PadInt pi_e1 = PadiDstm.AccessPadInt(201);
            PadInt pi_f1 = PadiDstm.AccessPadInt(101);
  ...
  //          if (!res) Console.WriteLine("$$$$$$$$$$$$$$ ABORT $$$$$$$$$$$$$$$$$");
        ...
        int h = pi_h.Read();
        int j = pi_j.Read();
        PadInt pi_g1 = PadiDstm.AccessPadInt(21);
        PadInt pi_h1 = PadiDstm.AccessPadInt(201);
        PadInt pi_j1 = PadiDstm.AccessPadInt(101);
        int g1 = pi_g1.Read();
        int h1 = pi_h1.Read();
        int j1 = pi_j1.Read();
        ...
        Console.WriteLine("21 = " + g1);
        Console.WriteLine("201 = " + h1);
        Console.WriteLine("101 = " + j1);
